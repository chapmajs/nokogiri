# -*- encoding: utf-8 -*-
# stub: nokogiri 1.10.2.20190404154312 ruby lib
# stub: ext/nokogiri/extconf.rb

Gem::Specification.new do |s|
  s.name = "nokogiri".freeze
  s.version = "1.10.2.20190404154312"
